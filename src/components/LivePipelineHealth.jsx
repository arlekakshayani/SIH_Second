...
export default function LivePipelineHealth({ onOpenMethodology }) {
  const pipelines = [
    {
      airline: 'IndiGo (6E)',
      code: '6E',
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-extrabold text-blue-950 bg-blue-100 hover:bg-blue-200 border border-blue-300 shadow-2xs transition-all active:scale-95 cursor-pointer"
            >
              <span>MoSPI 4-Step Econometric Breakdown (PDF)</span>
            </button>
          </div>
        </div>
