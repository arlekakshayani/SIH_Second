      ...
      <section className="banner-section inner relative h-[420px] sm:h-[460px] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Route Radar Analytics</span>
                ...
                <div className="search-content">
                  {filteredCorridors.length > 0 ? (
                    filteredCorridors.map((row) => (
                      <div key={row.id} className="search-row">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                          ...
                          <div>
                            <button
                              onClick={() => onNavigate('radar')}
                              className="search-title hover:underline cursor-pointer text-left"
                            >
                          ...
                          <div className="flex items-center gap-4 text-right">
                            <div>
                              <span className="text-[10px] text-slate-400 font-mono block">PURE BASE FARE</span>
                              <span className="text-base font-extrabold font-mono text-emerald-700">
                                ₹{row.pureFare.toLocaleString()}
                              </span>
                            </div>
                            <div className="hidden sm:block text-right">
                              <span className="text-[10px] text-slate-400 font-mono block">RAW TOTAL</span>
                            ...
                            <button
                              onClick={() => onNavigate('corridors')}
                              className="px-3 py-1.5 rounded-lg bg-orange-50 text-orange-700 hover:bg-orange-600 hover:text-white border border-orange-200 text-xs font-semibold transition-colors cursor-pointer"
                            >
                              Explore
                            </button>
                          </div>
